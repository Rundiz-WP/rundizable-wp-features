...
return [
    ...
    // @todo [rd-settings-fw] In your project, please change this settings config file name to yours settings config file name.
    'rundiz_settings_config_file' => 'settings_rdawpf',
];
