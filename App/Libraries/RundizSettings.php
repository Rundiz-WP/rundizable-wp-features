...
if (!class_exists('\\RundizableWpFeatures\\App\\Libraries\\RundizSettings')) {
    class RundizSettings
    {
        ...
        private function renderFormMedia($field_key, array $fields, array $options_values = [])
        {
            ...
            $output .= '<input type="button" class="button-secondary upload-media-button" value="'.__('Upload', 'rundizable-wp-features').'" data-input_target="'.$field_name.'">'."\n";
            $output .= '<input type="button" class="button-secondary remove-media-button" value="'.__('Remove', 'rundizable-wp-features').'" data-input_target="'.$field_name.'">'."\n";
